...
<head>
    ...
    <link rel="stylesheet" href="../../frontend/styles/veterinaire/animaux-veterinaire.css">
...
<h1 style="text-align: center; color: white;">Saisie de l'employé</h1>
...
<div class="crud-container">
    ...
    while($animaux = $recupAnimaux->fetch() AND $nourriture_animal = $recupNourriture->fetch() ) {
        ...
        <div class="crud-ligne">
            ...
            <a href="modifier-animal-veterinaire.php?id=<?= $nourriture_animal['id'];?>" style="text-decoration: none; color: green">Modifier</a>
        </div>
